...
// configuration step. It creates a namespace called `scaffold`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", scaffold::cmake::project_name, scaffold::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", scaffold::cmake::project_version);
      return EXIT_SUCCESS;
    }
